...
rem xcopy /v /Y %WINPCAPSOURCEDIR%\wpcap\libpcap\rpcapd\win32-pthreads\pthread.h	%WPDPACKDESTDIR%\Include\	 >nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\wpcap\libpcap\rpcapd\win32-pthreads\sched.h 	%WPDPACKDESTDIR%\Include\	 >nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\wpcap\libpcap\rpcapd\win32-pthreads\semaphore.h	%WPDPACKDESTDIR%\Include\	 >nul

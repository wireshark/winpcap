...
rem TME stuff, removed
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\bucket_lookup.h	 		%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\count_packets.h	 		%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\memory_t.h		 	%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\normal_lookup.h	 		%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\tcp_session.h		 	%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\time_calls.h		 	%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\packetNtx\driver\tme.h			 	%WPDPACKDESTDIR%\Include\	>nul

xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Packet32.h			 	%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Devioctl.h			 	%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Ntddndis.h			 	%WPDPACKDESTDIR%\Include\	>nul
rem xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Ntddpack.h			 	%WPDPACKDESTDIR%\Include\	>nul

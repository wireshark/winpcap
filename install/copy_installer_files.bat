...
copy ..\packetNtx\Dll\Project\Release\Packet.dll installer\distribution\2000\ >nul
copy ..\packetNtx\Dll\Project\Release_Vista\Packet.dll installer\distribution\Vista_x86\ >nul
copy ..\packetNtx\Dll\Project\NT4_Release\Packet.dll installer\distribution\NT\ >nul
copy ..\packetNtx\Dll\WanPacket\Release\WanPacket.dll installer\distribution\2000\ >nul
...
copy ..\wpcap\PRJ\Release_REMOTE\wpcap.dll installer\distribution\ >nul
copy ..\wpcap\PRJ\Release_REMOTE\rpcapd.exe installer\distribution\2000\ >nul
...
copy "WinPcap Installer Helper\Release\WinPcapInstall.dll" installer\distribution\2000\ >nul

copy ..\wpcap\libpcap\rpcapd\win32-pthreads\pthreadVC.dll installer\distribution\ >nul

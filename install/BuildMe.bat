...
msbuild MakeAll.sln /t:Build	/p:Configuration="Release NT4"			/p:Platform="x64"
...
msbuild MakeAll.sln /t:Build	/p:Configuration="Release NT4 LOG_TO_FILE"	/p:Platform="x64"
...
msbuild MakeAll.sln /t:Build	/p:Configuration="Debug NT4"			/p:Platform="x64"

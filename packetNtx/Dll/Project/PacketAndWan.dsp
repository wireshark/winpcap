...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../../../dag/include" /I "../../../dag/drv/windows" /I "../../../common" /I "..\..\driver" /D "NDEBUG" /D "HAVE_DAG_API" /D "WIN32" /D "_WINDOWS" /D "PACKET_AND_WAN" /YX /FD /c
...
# ADD LINK32 Ws2_32.lib ..\wanpacket\release\wanpacket.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib Iphlpapi.lib version.lib npptools.lib /nologo /subsystem:windows /dll /machine:I386 /out:"Release/Packet.dll"
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "../../../dag/include" /I "../../../dag/drv/windows" /I "../../../common" /I "..\..\driver" /D "HAVE_DAG_API" /D "WIN32" /D "_WINDOWS" /D "PACKET_AND_WAN" /YX /FD /c
